...
const updateShim = {
    ...
    getVersion: () => Promise.resolve({ success: true, version: '1.0.5-beta-web' }),
...
export const electronAPIShim = {
    ...
    getVersion: () => Promise.resolve('1.0.5-beta-web'),
    getAppVersion: () => Promise.resolve({ success: true, version: '1.0.5-beta-web' }),
